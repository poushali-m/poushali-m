# Hi, I'm Poushali Majumder 👋

🎓 First-Class BSc Cyber Security Graduate — University of West London  
🛡️ Aspiring SOC Analyst | Threat Detection | Incident Response | GRC  
📍 London, UK  
...
| Project | Description |
|---------|-------------|
| [Insider Threat Detection](https://github.com/poushali-m/insider-threat-detection) | ML-based behavioural risk scoring model built with Python, scikit-learn & Streamlit |
| [SOC Threat Detection Lab](https://github.com/poushali-m/soc-threat-detection-lab) | SSH brute-force simulation, log analysis, UFW containment & incident report |
| [Windows SOC Investigation](https://github.com/poushali-m/windows-soc-investigation-lab) | PowerShell Event ID 4625 analysis & brute-force pattern detection |
| [Vulnerability Assessment Lab](https://github.com/poushali-m/vulnerability-assessment-lab) | Nmap-based assessment with manual risk analysis & remediation report |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://linkedin.com/in/poushali23)
[![Portfolio](https://img.shields.io/badge/Portfolio-50C8A0?style=flat&logoColor=white)](https://poushali-m.github.io)
[![Email](https://img.shields.io/badge/Email-D14836?style=flat&logo=gmail&logoColor=white)](mailto:poushali.majumder.uk@gmail.com)
